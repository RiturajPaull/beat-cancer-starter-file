...
const Model = ({ title, children, isOpen, onClose, onAction, actionLabel }) => {
  if (!isOpen) return null;
  return (
    <div className="fixed left-0 top-0 z-[80] flex h-full w-full items-center justify-center bg-opacity-90">
      <div className="relative w-11/12 rounded-xl border border-gray-200 border-neutral-800 bg-[#13131a] shadow-sm md:w-1/2 lg:w-1/3">
