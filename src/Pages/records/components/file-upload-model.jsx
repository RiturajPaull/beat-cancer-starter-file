...
const FileUploadModel = ({
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-slate-700 p-8 text-slate-300">
        <svg
      ...
      {uploading && (
        <IconProgress size={10} className="mr-3 h-7 w-7 animate-spin" />
      )}
      {uploadSuccess && (
